...
class _PreparedTopicPayload:
    ...
    tokenizes raw text itself, so unlike the old BERTopic path this no longer
    carries pre-tokenized "vectorizer corpora" -- only the raw documents per
    node plus display names.
    """
